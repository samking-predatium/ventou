...
class TabletVerifierCompte extends StatefulWidget {
  const TabletVerifierCompte({super.key});

  @override
  State<TabletVerifierCompte> createState() => _TabletVerifierCompteState();
}

class _TabletVerifierCompteState extends State<TabletVerifierCompte> {
...
// REDIRECTION VERS ECRAN DE VERIFICATION DE CODE SEND PAR MAIL
      ...
      navigator.push('/tablet-verifier-code-send');
    } catch (e) {
      if (mounted) {
        setState(() {
          _hasError = true;
