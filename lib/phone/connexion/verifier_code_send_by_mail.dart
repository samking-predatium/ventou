...
class VerifierCodeSendByMail extends StatefulWidget {
  const VerifierCodeSendByMail({super.key});

  @override
  State<VerifierCodeSendByMail> createState() => _VerifierCodeSendByMailState();
}

class _VerifierCodeSendByMailState extends State<VerifierCodeSendByMail> {
