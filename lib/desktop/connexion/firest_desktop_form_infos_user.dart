...
import 'package:ventou/desktop/connexion/second_desktop_form_infos_user.dart';
...
class FirestDesktopFormInfosUser extends StatefulWidget {
  const FirestDesktopFormInfosUser({super.key});

  @override
  State<FirestDesktopFormInfosUser> createState() =>
      _FirestDesktopFormInfosUserState();
}

class _FirestDesktopFormInfosUserState
    extends State<FirestDesktopFormInfosUser> {
  ...
  void _validateAndNavigate() {
    ...
    if (nomError == null &&
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => SecondDesktopFormInfosUser(userData: userData),
        ),
      );
    }
  }
